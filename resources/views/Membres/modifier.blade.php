              ...
              <input class="form-control" id="fPrenom" type="text">
                  ...
                  <div class="form-group">
                      <label for="fNom">*Nom(information non visible aux membres)</label>
                          <input class="form-control" id="fNom" type="text" value="{{ $LoggedUserInfo['pseudo'] }}">
                  </div>
                  <div class="form-group">
                      <label for="fMail">*Courriel(information non visible aux membres)</label>
                          <input class="form-control" id="fMail" type="text" value="{{ $admin['courriel'] }}">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      <label for="fPseudo">*Mot de passe actuel</label>
                          <input class="form-control" id="fPseudo" type="text">
                  </div>
                  <div class="form-group">
                      <label for="fpassword">*Nouveau mot de passe (6 caractère minimum)</label>
                          <input class="form-control" id="fpassword" type="password">
                  </div>
                  <div class="form-group">
                      <label for="fcpassword">*Confirmation de nouveau mot de passe</label>
                          <input class="form-control" id="fcpassword" type="password">
                  </div>
