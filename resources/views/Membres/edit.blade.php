...
<section>
  ...
  <div id="connectBox"> </div>
        <div class="container">   
            ...
            <br><br>
            <form enctype="multipart/form-data" action="{{route('auth.update', $admin)}}" method="POST" id="formulaireInscription" name="formulaireInscription" role="form">
		...
		<div class="form-group">
			<label for="fImage">*Choisissez l'image de profil</label><br/>
			<input accept="image/*" class="fa fa-search" id="fImage" type="file" name="photo" accept="image/*" onchange="previewFile(this)" placeholder="formats acceptes : .JPG, .GIF, .JPEG" size="34%" >
			<br>
            <img id="previewImg" alt="profile image" style="max-width: 200px; margin-top:20px;" />            
        </div>				
