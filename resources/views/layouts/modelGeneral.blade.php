...
<body>
    <div id="header">
		<div id="logo">
   	        <a class="logo" href="home"><img src="../images/home/logo.jpg" size="90%"></a>
        </div> 
        
		<div id="btnNav3"><button class="btn"><a href="{{route('auth.login')}}">Connectez-vous</a></button></div>
        <div id="btnNav4"><button class="btnMoreWords"><a href="creercompte">Creer un compte gratuiment</a></button></div>
    </div>
