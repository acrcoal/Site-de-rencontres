...
<div id="header">
    ...
    <div id="btnNav3"><button class="btn" ><a href="{{route('membres.showAll')}}">Mes favoris</a></button></div>
		...
		<a class="welcome" href="{{route('membres.chat')}}">CHAT&nbsp&nbsp&nbsp|</a>
		<a class="welcome" href="{{route('membres.recherchermembre')}}">RECHERCHE&nbsp&nbsp&nbsp|</a> 
		<a class="welcome" href="{{route('blogs.showAllBlog')}}">BLOG&nbsp&nbsp&nbsp&nbsp|</a>
		<a class="welcome" href="{{route('groupes.createGroupe')}}">CREER UNE GROUPE&nbsp&nbsp&nbsp&nbsp|</a>		
        <a class="welcome" href="{{ route('auth.logout') }}">FERMER SESSION</a>
	</div>
